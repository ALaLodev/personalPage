...
const translations = {
    ...
    skylinkAdminTitle: { es: 'SkyLink GDS — Backend & B2B Dashboard', en: 'SkyLink GDS — Backend & B2B Dashboard' },
    ...
    skylinkMobileTitle: { es: 'SkyLink GDS — App Pasajeros (Android)', en: 'SkyLink GDS — Passenger App (Android)' },
